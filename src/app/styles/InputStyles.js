...
const InputStyles = {
  ...
  formWrapper: `
    ...
    rounded-2xl p-6 sm:p-10 space-y-8 transition-all duration-300
  `,
  title: `
    text-2xl sm:text-3xl font-bold text-center text-blue-900
  `,
  gridLayout: `
...
// tds file
  containerWrapper: `
    mx-auto max-w-5xl w-full p-4 md:p-8 bg-white shadow-xl rounded-xl border border-blue-100
  `,
  table: `overflow-x-auto rounded-lg shadow border border-gray-200`,
  tableHeader: `bg-blue-100 text-blue-800 text-sm uppercase`,
...
tdstitle: `text-2xl font-bold text-blue-900 mb-6 text-center border-b pb-2`,
...
//  sectionTitle: 'text-lg font-semibold text-gray-700',
...
// form16component
  ...
  form16table:` mx-auto w-full max-w-3xl px-6 sm:px-10 py-8
    ...
    form16tableunder: `
       ...
       section80Deduction:` mx-auto w-full max-w-4xl px-6 py-8 sm:px-10
    ...
    hover:shadow-2xl hover:scale-[1.01]`,
         ...
         section80Deductiontitle: `text-xl sm:text-2xl font-bold text-gray-800 border-b-2 border-blue-500 pb-2 mb-5 inline-block transition-all duration-300`,
