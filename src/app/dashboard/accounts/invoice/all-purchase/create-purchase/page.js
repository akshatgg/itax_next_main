        ...
        <ul className="mt-2 grid grid-cols-7 gap-4 min-w-[40rem] items-center">
            <li>
                <input
                    ...
                    className="bg-neutral-50 border p-2 rounded w-full"
            ...
            <li>
                <button
                    ...
                    className="flex items-center justify-center text-red-500 border border-red-500 rounded-lg p-2"
                >
...
export default function CreatePurchase() {
    ...
    return (
        <section className="p-4 max-w-6xl mx-auto">
            <form onSubmit={handleSubmit(onCreatePurchase)} className="space-y-6">

                {/* Party Details */}
                <p className={formClasses.formSectionTitle}>Party Details</p>
                <ul className={formClasses.gridUL}>
                    <li>
                        <label htmlFor="supplier" className={formClasses.label}>
                            Supplier
                        </label>
                        <input
                            type="text"
                ...
                {/* Purchase Details */}
                <p className={formClasses.formSectionTitle}>Purchase Details</p>
                <ul className={formClasses.gridUL}>
                    <li>
                        <label htmlFor="purchase_date" className={formClasses.label}>
                            Purchase Date
                        </label>
                        <input
                            type="date"
                ...
                <div className="my-4 flex items-center space-x-3 bg-blue-50 dark:bg-blue-950 p-2 rounded">
                    ...
                    <label className="relative inline-flex cursor-pointer items-center">
                        ...
                        />
                        <div
                            className={`h-6 w-11 rounded-full transition-all ${isCredit ? "bg-blue-400 after:translate-x-full" : "bg-gray-400"
                                } relative after:absolute after:top-0.5 after:left-0.5 after:h-5 after:w-5 after:bg-white after:rounded-full after:shadow after:transition-transform`}
                        ></div>
                    </label>
                </div>
                ...
                <ul className={formClasses.gridUL}>
                    {!isCredit && (
                        <li>
                            <label htmlFor="mode_of_payment" className={formClasses.label}>
                                Mode of Payment
                            </label>
                            <select
                                id="mode_of_payment"
                    ...
                    <li>
                        <label htmlFor="State" className={formClasses.label}>
                            State
                        </label>
                        <select
                            id="State"
                ...
                <div className="overflow-auto">
                    ...
                    <button
                        type="button"
                        onClick={addItem}
                        className="mt-4 flex items-center text-blue-500 border border-blue-500 rounded-lg px-4 py-2"
                    >
                        Add Items
                    </button>
                </div>
