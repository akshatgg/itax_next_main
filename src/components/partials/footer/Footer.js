...
export default function Footer() {
  // Initialize socials with an empty object to avoid undefined errors
          ...
          <div className="flex flex-col md:flex-row">
            ...
            <div className="flex flex-col md:flex-row items-start justify-between md:ml-auto mt-8 md:mt-0">
              ...
              <div className="mx-8">
                ...
                <ul className="font-medium text-sm leading-7 my-2">
                  <li>
                    <a href={`tel:${socials?.phone || '+918770877270'}`}>
                      Contact us: {socials?.phone || 'Not available'}
                    </a>
                  </li>
                  <li>
                    <a href={`mailto:${socials?.email || 'info@example.com'}`}>
                      {socials?.email || 'Not available'}
                    </a>
                  </li>
                </ul>
              </div>
