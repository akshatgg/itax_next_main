  ...
  return (
    ...
    >
      {(values) => (
       ...
       <Form>
           <div className={InputStyles.form16table}>
            <div className={InputStyles.form16tableunder}>
              <div className="col-span-3 p-2 text-xs text-gray-200 uppercase bg-blue-200 dark:text-gray-400">
                <div className=" flex items-center gap-2 flex-wrap">
                  <label className={InputStyles.label}>Name of Employer:</label>
                  <Field
                    type="text"
                  ...
                  <ErrorMessage
                    name="nameOfEmployer"
                    component="span"
                    className={InputStyles.form16ErrorSms}
                  />
                </div>
              </div>
              <div className="col-span-2">
