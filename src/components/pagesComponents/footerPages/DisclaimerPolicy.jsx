...
const DisclaimerPolicy = () => {
  return (
    <>
      <div className="bg-blue-500 py-[5rem] px-10 ">
      ...
      <div className="container text-justify mx-auto text-serif mb-20 py-20 bg-gray-100 rounded-lg shadow-lg px-10">
        <h5 className="text-lg font-italic  font-semibold  pb-5">
          ...
          Access Or Use The Site. Itax Easy may Modify This Agreement At Any
        ...
        <h5 className="tctext">
          ...
          Shall Have No Recourse Against Itax Easy for Any Alleged Or Actual
          Infringement Or Misappropriation Of Any Proprietary Right In Your
          Communications To Itax Easy.
        </h5>
        <h1 className="text-xl font-bold   pt-5 pb-2">Trademarks</h1>
        <h5 className="tctext">
        ...
        <h1 className="text-xl font-bold    pt-5 pb-2">2. Use Of The Site</h1>
        <h5 className="tctext">
          Except For The Information, Products Or Services Clearly Identified As
          Being Supplied By Itax Easy, Itax Easy does Not Operate, Control Or
          ...
          Are Not Affiliated With Itax Easy. You Also Understand That Itax Easy
        ...
        <h5 className="tctext">
          ...
          The Internet. Itax Easy provides The Site And Related Information
          ...
          Easy shall Not Be Liable For Any Cost Or Damage Arising Either
          ...
          Provided Through The Service Or On The Internet Generally. Itax Easy
          ...
          You. Your Access To Such Materials Is At Your Risk. Itax Easy Has No
        ...
        <h1 className="text-xl font-bold    pt-5 pb-2">3. Indemnification</h1>
        <h5 className="tctext">
        ...
        <h1 className="text-xl font-bold    pt-5 pb-2">5. Terms Termination</h1>
        <h5 className="tctext">
        ...
        <h1 className="text-xl font-bold    pt-5 pb-2">6. Miscellaneous</h1>
        <h5 className="tctext">
