...
export default function SoftwareLicense() {
          ...
          <ul className="space-y-4">
            <li className="space-y-2">
              <p className="text-gray-700">
                ...
                and non-exclusive license to use, solely in the Field and solely
                in object code form, the Software.
              </p>
            </li>
            <li className="space-y-2">
              <p className="text-gray-700">
                Reservation of rights: Except for the license explicitly granted
        ...
        <div className="space-y-6">
          <div>
            ...
            <p className="text-gray-700 mb-3">
              Except to the extent permitted by applicable mandatory law, the
              End User shall not:
            </p>
          ...
          <div className="bg-green-50 border border-green-200 rounded-lg p-4">
            ...
            <p className="text-gray-700">
              ...
              Software must be used in accordance with the terms and conditions
              set forth in this agreement. The End User should comply with the
              Fair usage policy of the Company and that violation of this policy
              may result in revocation of the license and denial of user access
              to the Software. The Fair usage policy is subject to change from
              time to time.
            </p>
          </div>
        </div>
          ...
          <div className="bg-blue-50 border border-blue-100 rounded-lg p-5">
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <p className="text-gray-700">
                  End User agrees to the commercial terms as selected or opted
                  by it. Invoices will be sent in electronic form/soft copy via
                  email only.
                </p>
              </li>
              <li className="flex items-start gap-3">
                ...
                <p className="text-gray-700">
                  The Fee applicable to a billing cycle will be paid in advance
                  at the beginning of the Billing Cycle. Advance fees once paid
              ...
              <li className="flex items-start gap-3">
                ...
                <p className="text-gray-700">
                  ...
                  applicable taxes that may be levied by the Government from
                  time to time, which shall be paid by the End User to the
                  Licensor in addition at the rate and in the manner prescribed
                  by applicable law;
                </p>
              </li>
              <li className="flex items-start gap-3">
  ...
  referred to as &quot;Confidential Information&quot;.
              ...
              <li className="flex items-start gap-3">
                ...
                <p className="text-gray-700">
                  ...
                  sub-contractors, vendors and agents that may or are likely to
                  receive the Confidential Information to comply with the terms
                  of this agreement and each Party shall continue to be
                  primarily responsible for any breach hereof by its employees,
                  Affiliates, sub-contractors, vendors, and/or agents.
                </p>
              </li>
              <li className="flex items-start gap-3">
                <div className="flex-shrink-0 w-6 h-6 bg-purple-500 rounded-full flex items-center justify-center mt-0.5 text-white font-bold text-xs">
                  ...
                  <ul className="space-y-2 pl-4">
                    <li className="flex items-start gap-2">
                      ...
                      <span className="text-gray-700 text-sm">
                        disclosure of Confidential Information that is or
                        becomes generally available to the public other than as
                        a result of disclosure by or at the direction of a Party
                        or any of its Representatives in violation of this
                        Agreement;
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="w-2 h-2 bg-purple-500 rounded-full mt-2 flex-shrink-0"></div>
                      <span className="text-gray-700 text-sm">
                        disclosure by Parties to its representatives provided
                        such Representatives are bound by similar
                    ...
                    <li className="flex items-start gap-2">
                      <div className="w-2 h-2 bg-purple-500 rounded-full mt-2 flex-shrink-0"></div>
                      <span className="text-gray-700 text-sm">
                        disclosure, after giving prior notice to the other
                        Parties to the extent practicable under the
                        circumstances and subject to any practicable
                        arrangements to protect confidentiality, to the extent
                        required under the rules of any stock exchange or by
                        Applicable Laws or government regulations or generally
                        accepted accounting principles and standards applicable
                        to any Party or judicial or regulatory process or in
                        connection with any judicial process, regarding any
                        legal action, suit or proceeding, arising out of or
  ...
  representatives or out of breach of this agreement.
              ...
              <li className="flex items-start gap-3">
                ...
                <p className="text-gray-700">
                  End User shall indemnify the Licensor from and against any and
                  all losses, damages, claims, demands, liabilities, costs, and
                  expenses of any nature whatsoever that may be asserted against
                  or suffered by the Licensor and which relate to: (a) any
                  breach by the customer and/or other Third Party engaged by the
                  customer, of its obligations under any applicable law(s),
                  statutory instructions, notifications, guidelines as may be
                  issued by the Government due to which Licensor may be held
              ...
              <li className="flex items-start gap-3">
                ...
                <p className="text-gray-700">
                  This clause shall survive for 1 year after the expiry or
        ...
        <div className="bg-amber-50 border border-amber-200 rounded-lg p-6">
          <div className="flex items-start gap-3">
            ...
            <p className="text-gray-700">
              ...
              statute or otherwise), including the work, deliverables or
              Services covered by this Agreement, shall be the payment of direct
              damages only which shall be limited in accordance with the
              provisions of this Clause. In no event, the cumulative liability
              of the Licensor in respect of any and all claims made under or in
              connection with this AGREEMENT shall not exceed an amount that is
              equal to license fees received under this agreement.
            </p>
          </div>
        </div>
      ),
          ...
          <div className="bg-blue-50 border border-blue-100 rounded-lg p-5">
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <p className="text-gray-700">
                  This agreement comes into effect from the date of its
                  acceptance by the Customer and shall remain operative for a
                  period of three (3) Years from such date. Any extension to
                  this agreement requires express and written consent of both
                  the parties.
                </p>
              </li>
              <li className="flex items-start gap-3">
                ...
                <p className="text-gray-700">
                  Licensor may terminate this Agreement, if Customer does not
                  meet its obligation to make payment as per agreed terms.
                </p>
              </li>
              <li className="flex items-start gap-3">
                <div className="flex-shrink-0 w-6 h-6 bg-blue-500 rounded-full flex items-center justify-center mt-0.5 text-white font-bold text-xs">
                ...
                <p className="text-gray-700">
                  ...
                  shall have a receiver or administrative receiver appointed of
                  it or over any part of its undertaking or assets or shall pass
                  a resolution for winding up (otherwise than for a purpose of
                  bonafide scheme of solvent amalgamation or reconstruction) or
                  a court of competent jurisdiction shall make an order to that
                  effect or if the Customer becomes subject to an administration
                  order or shall enter into any voluntary arrangement with its
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start gap-3">
                ...
                <p className="text-gray-700">
                  ...
                  approval/s, permission from statutory authorities, in respect
                  of their scope of Services to be provided under this
                  agreement.
                </p>
              </li>
            </ul>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <p className="text-gray-700">
                  ...
                  arise between the Parties in connection with or arising out of
                  this Agreement (whether before or after the termination or
                  breach of this Agreement) the concerned representatives of the
                  Parties shall promptly and in good faith negotiate with a view
              ...
              <li className="flex items-start gap-3">
                ...
                <p className="text-gray-700">
                  ...
                  within a period of thirty (30) days, such dispute or
                  difference shall be referred to a sole arbitrator mutually
                  appointed by the Parties or, upon the failure of the Parties
                  to agree upon a sole arbitrator, within a period of ten (10)
                  days, each Party shall appoint one arbitrator each and the two
              ...
              <li className="flex items-start gap-3">
                ...
                <p className="text-gray-700">
                  ...
                  or continuance of the arbitration proceedings shall not
                  postpone or delay the performance by the Parties of their
                  respective obligations pursuant to this Agreement. It is
                  agreed that the arbitrators shall also determine and make an
      ...
      content: (
        <div className="space-y-6">
          <div className="bg-gray-50 border border-gray-200 rounded-lg p-5">
            ...
            <p className="text-gray-700">
              This EULA may only be amended in writing signed by duly authorised
...
represent that it has authority to make any commitments on the other&apos;s behalf.
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-lg p-5">
            ...
            <p className="text-gray-700">
              End User hereby agrees and undertakes that End User is legally
              entitled and eligible to enter into this e-Agreement and further
              agrees and undertakes to be bound by and abide by this Agreement
              and the person accepting this Agreement by and on behalf of the
              Entity is authorized representative of the Entity and is entitled
              and is legally authorized to bind the Entity on whose behalf this
              Agreement is being accepted.
            </p>
          </div>
        </div>
      ),
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-green-700 leading-relaxed">
                  By using iTaxEasy software, you acknowledge that you have read
                  and understood this End User License Agreement and agree to be
