...
export default function DashSection(props) {
  ...
  return (
    <section
          className={`shadow-sm border border-gray-200/60 rounded-xl w-full bg-blue-100 overflow-hidden mt-2 mx-auto md:w-[calc(100%-3rem)] ${className}`}
     >
      <div 
      className="capitalize flex justify-between flex-wrap items-center"
      >
        <h2 
