...
function NewTaxCalculator() {
  ...
  return (
    <div className="my-8 flex flex-col justify-center">
       <div className="mb-2 sm:text-start text-center mx-auto px-2 w-[calc(100%-2rem)] md:max-w-[calc(950px-2rem)] text-gray-800 border-l-4 border-blue-500 shadow shadow-blue-500 py-2 rounded-md">
    ...
    <div
        className={` ${classes} ${classes2} mx-auto w-[calc(100%-2rem)] md:max-w-[calc(950px-2rem)]  shadow-sm shadow-blue-400 rounded-md border border-primary_light p-8 [&>div]:border-b [&>div]:border-b-primary_light [&_div]:flex [&_div]:items-center [&_div]:justify-between [&_div]:gap-2 [&_div]:py-1`}
        id="advancetaxdiv"
      >
        <form onSubmit={handleSubmit(submitHandler)}>
          ...
          <section className="mt-8 flex justify-center gap-8">
            ...
            <button
              type="button"
              className="rounded hover:bg-green-600 bg-green-500 p-2 px-6 text-white hover:opacity-75"
...
const classes =
  '[&_input]:h-10 [&_input]:px-3 [&_input]:border [&_input]:border-neutral-800 [&_input]:rounded [&_input]:w-full [&_input]:mb-2';
const classes2 =
  '[&_select]:h-10 [&_select]:bg-white [&_select]:border [&_select]:border-neutral-800 [&_select]:px-2 [&_select]:rounded [&_select]:w-full [&_select]:mb-2 [&_label]:text-lg [&_label]:mb-1';
