...
const CapitalGainCal = () => {
  ...
  return (
    <SearchResult_section title="Capital Gain Calculator">
      ...
      {showStat && (
        <li className="lg:col-span-2 space-y-4 bg-gray-200 p-4 overflow-hidden" ref={pdf_ref}>
          <div className="bg-neutral-50 p-4 overflow-hidden">
            <div className="mx-auto p-4 bg-neutral-50">
              <div className="w-1/2 mx-auto">
                <Pie data={data} />
              </div>
            </div>
            <div className="grid grid-cols-[repeat(auto-fill,_minmax(150px,_1fr))] gap-4 place-content-center ">
              <div className=" p-3 rounded-lg shadow-lg bg-white">
                <h5 className="text-gray-900 text-lg leading-tight font-medium mb-5 ">
                  Purchase Price
                </h5>
