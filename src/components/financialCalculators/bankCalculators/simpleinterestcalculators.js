              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <select
                    ...
                    className="w-full border-2 border-blue-100 rounded-lg p-3 text-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all cursor-pointer"
                  >
                ...
                <div className="bg-gradient-to-br from-blue-50 to-blue-100 shadow-md rounded-xl p-5 border border-blue-100">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex justify-between items-center bg-blue-50 rounded-lg p-3">
                      ...
                      <span className="text-blue-900 font-bold font-mono">₹{totalInterest.toFixed(0)}</span>
                    </div>
